...
\begin{table}[h!]
	\centering
	\begin{tabularx}{1\textwidth}{|c|c|c|C|} %TODO riprovare tabularx per fare la tabella larga quanto tutta la pagina
		\toprule
		Indirizzo di memoria & Valore binario & Valore decimale & Commento \\
		\midrule
		0 & 00000011 & 3 & Numero di parole in ingresso and and and and and and \\
		\midrule
